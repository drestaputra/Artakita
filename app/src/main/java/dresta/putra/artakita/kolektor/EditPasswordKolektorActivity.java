package dresta.putra.artakita.kolektor;
...
public class EditPasswordKolektorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_password_kolektor);
        prefManager = new PrefManager(EditPasswordKolektorActivity.this);
        ...
        servicePojo = RetrofitClientInstance.getRetrofitInstance(EditPasswordKolektorActivity.this).create(APIGantiPassword.class);
            ...
            public void run() {
                ...
                responsePojoCall.enqueue(new Callback<ResponsePojo>() {
                    ...
                    public void onResponse(Call<ResponsePojo> call, Response<ResponsePojo> response) {
                        if (response.body()!=null){
                            if (response.body().getStatus() == 200){
                                button.setEnabled(true);
                                DrawableButtonExtensionsKt.hideProgress(button, "Simpan");
                                Toast.makeText(EditPasswordKolektorActivity.this, "Ubah password berhasil, mohon login ulang", Toast.LENGTH_LONG).show();
                                prefManager.logout();
                            }else{
                                button.setEnabled(true);
                                DrawableButtonExtensionsKt.hideProgress(button, "Simpan");
                                Toast.makeText(EditPasswordKolektorActivity.this, response.body().getMsg(), Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                    ...
                    public void onFailure(Call<ResponsePojo> call, Throwable t) {
                        button.setEnabled(true);
                        Toast.makeText(EditPasswordKolektorActivity.this, "Gagal, coba lagi", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        },3000);
